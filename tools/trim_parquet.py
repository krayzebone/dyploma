...
# Paths
input_path  = r"neural_networks\rect_section_n2\dataset\dataset_rect_n22.parquet"
output_path = r"neural_networks\rect_section_n2\dataset\dataset_rect_n2.parquet_40k"
