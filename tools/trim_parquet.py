...
# Paths
input_path  = r"neural_networks\rect_section_n1\dataset\dataset_rect_n1_test5.parquet"
output_path = r"neural_networks\rect_section_n1\dataset\dataset_rect_n1_test5_40k.parquet"

# Read the full dataset
df = pd.read_parquet(input_path)

# Take a random 100_000-row sample (reproducible)
df_trim = df.sample(n=40_000, random_state=42)
