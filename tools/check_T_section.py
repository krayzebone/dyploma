...
def predict_sectionn2(MEqp: float, beff: float, bw:float, h: float, hf: float, fck: float, fi: float, cnom: float, As1: float, As2: float):
 ...
 #n1={'MEd': 400.0, 'beff': 900.0, 'bw': 800.0, 'h': 300.0, 'hf': 100.0, 'cnom': 30.0, 'fck': 45.0, 'fi': 20.0, 'n1': 19.0, 'd': 260.0, 'As1': 5969.026041820607, 'ro1': 0.02387610416728243, 
  #   'As2': 0.0, 'ro2': 0.0, 'n2': 0.0, 'Mcr': 121.588623046875, 'MRd': 555.3248901367188, 'Wk': 0.16383515298366547, 'Cost': 382.1951130268216}
