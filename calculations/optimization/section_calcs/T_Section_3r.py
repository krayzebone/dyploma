...
def check_section_type_3r(MEd: float, beff: float, h: float, hf: float, figl: float, fck: float):
...
def PT_Section_3r(MEd: float, beff: float, h: float, figl: float, fck: float):
...
def RZT_Section_3r(MEd: float, beff: float, bw: float, h: float, hf: float, figl: float, fck: float):
