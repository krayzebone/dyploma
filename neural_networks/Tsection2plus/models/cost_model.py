...
DATA_CONFIG = {
    'filepath': r"dataset_files\Tsectionplus\Tsection2_100k.parquet",
...
TRANSFORMATION_CONFIG = {
    'features': {
        ...
        'fistr': {'transform': log_transform, 'inverse_transform': log_inverse, 'epsilon': 1e-8},
...
OUTPUT_CONFIG = {
    'save_path': r"nn_models\T_section2_plus\cost",
    'visualization': {
        'max_samples': 100000,
        'histogram_bins': 100
    },
