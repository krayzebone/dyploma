...
df_lambda_probe = pd.read_parquet(DATA_CONFIG['filepath']).iloc[:100_000]
...
MODEL_CONFIG = {
    'hidden_layers': [
        {'units': 478, 'activation': 'relu', 'dropout': 0.000248840308811265},
    ],
    'output_activation': 'linear'
}

TRAINING_CONFIG = {
    'optimizer': Adam(learning_rate=0.00789067825210603),
    'loss': 'mse',
    'metrics': ['mse', 'mae'],
    'batch_size': 256,
    'epochs': 300,
