...
DATA_CONFIG = {
    ...
    'features': ["b", "h", "d", "fi", "cnom", "fck", "ro1", "ro2"],
    'target': "MRd",
    'test_size': 0.3,
    'random_state': 42
}
...
TRANSFORMATION_CONFIG = {
    'features': {
        ...
        'ro2':      {'transform': log_transform,     'inverse_transform': log_inverse,      'scaler': StandardScaler(), 'epsilon': 1e-10},
    },
...
def main():
    ...
    df['predicted_MRd'] = full_pred
    df['error'] = df[DATA_CONFIG['target']] - df['predicted_MRd']
