...
"""
Script to load a trained model (and scalers) for Mcr prediction,
...
DATA_FILEPATH = r"dataset_files\Tsection\Tsection_balanced2.parquet"
MODEL_FOLDER  = r"nn_models\Tsection\T2"

# Name of the target column in the dataset
TARGET_COLUMN = "rods_layer1"
...
fallback_TRANSFORMATION_CONFIG = {
    'features': {
        ...
        'fi_str': {'transform': log_transform, 'inverse_transform': log_inverse, 'epsilon': 1e-8},
...
def main():
    ...
    features_used = ["MEd", "beff", "bw", "h", "hf", "fi", "fck", "fi_str", "cnom"]
